...
public interface ModBlockEntities {
    ...
    BlockEntityType<GeodinBlockEntity> GEODIN = Registry.register(Registries.BLOCK_ENTITY_TYPE, new Identifier(Pyrellium.MOD_ID, "geodin"), FabricBlockEntityTypeBuilder.create(GeodinBlockEntity::new).addBlocks(ModBlocks.SLEEPING_AMETHYST_GEODIN, ModBlocks.SLEEPING_OPAL_GEODIN).build());
