...
public interface ModBlockEntities {
    ...
    BlockEntityType<GeodinBlockEntity> GEODIN = Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(Pyrellium.MOD_ID, "geodin"), FabricBlockEntityTypeBuilder.create(GeodinBlockEntity::new, ModBlocks.SLEEPING_AMETHYST_GEODIN, ModBlocks.SLEEPING_OPAL_GEODIN, ModBlocks.SLEEPING_QUARTZ_GEODIN).build());
