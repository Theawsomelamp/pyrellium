...
public class BlockTagDataGen extends FabricTagProvider.BlockTagProvider{
    ...
    protected void configure(RegistryWrapper.@NonNull WrapperLookup wrapperLookup) {
        ...
        valueLookupBuilder(BlockTags.IRON_ORES).add(
                ModBlocks.BASALT_IRON_ORE
        );
        ...
        valueLookupBuilder(ConventionalBlockTags.BUDDING_BLOCKS).add(
                ModBlocks.BUDDING_OPAL,
                ModBlocks.BUDDING_QUARTZ
        );

        valueLookupBuilder(ConventionalBlockTags.BUDS).add(
                ModBlocks.SMALL_OPAL_BUD,
                ModBlocks.MEDIUM_OPAL_BUD,
                ModBlocks.LARGE_OPAL_BUD,
                ModBlocks.SMALL_QUARTZ_BUD,
        ...
        valueLookupBuilder(ConventionalBlockTags.CLUSTERS).add(
                ModBlocks.OPAL_CLUSTER,
                ModBlocks.QUARTZ_CRYSTAL
        );
    }
