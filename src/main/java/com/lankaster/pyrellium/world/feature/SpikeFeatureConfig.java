...
public record SpikeFeatureConfig(Direction direction, IntProvider height, IntProvider radius, BlockStateProvider state, BlockStateProvider tip, float chance) implements FeatureConfig {
