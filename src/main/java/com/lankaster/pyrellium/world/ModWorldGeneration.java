...
public class ModWorldGeneration {
    ...
    private static void generateBiomes() {
        Config.BiomeNoise biomeNoise;

        if (Config.instance().biomes.blackstone_springs.enable_biome) {
            biomeNoise = Config.instance().biomes.blackstone_springs.biome_noise;
        ...
        if (Config.instance().biomes.burning_grove.enable_biome) {
            biomeNoise = Config.instance().biomes.burning_grove.biome_noise;
        ...
        if (Config.instance().biomes.crystal_forest.enable_biome) {
            biomeNoise = Config.instance().biomes.crystal_forest.biome_noise;
        ...
        if (Config.instance().biomes.frostburn_valley.enable_biome) {
            biomeNoise = Config.instance().biomes.frostburn_valley.biome_noise;
        ...
        if (Config.instance().biomes.ghostly_woods.enable_biome) {
            biomeNoise = Config.instance().biomes.ghostly_woods.biome_noise;
        ...
        if (Config.instance().biomes.infested_valley.enable_biome) {
            biomeNoise = Config.instance().biomes.infested_valley.biome_noise;
        ...
        if (Config.instance().biomes.monolith_plains.enable_biome) {
            biomeNoise = Config.instance().biomes.monolith_plains.biome_noise;
        ...
        if (Config.instance().biomes.mushroom_wastes.enable_biome) {
            biomeNoise = Config.instance().biomes.mushroom_wastes.biome_noise;
        ...
        if (Config.instance().biomes.quartz_caverns.enable_biome) {
            biomeNoise = Config.instance().biomes.quartz_caverns.biome_noise;
