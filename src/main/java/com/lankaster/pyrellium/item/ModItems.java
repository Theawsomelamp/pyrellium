...
public class ModItems {
    ...
    public static final Item OPAL_SPYGLASS = registerItem("opal_spyglass", new OpalSpyglassItem(new Item.Settings().maxCount(1)));
    public static final Item OPAL_TIARA = registerItem("opal_tiara", new DescriptiveArmorItem(ModArmorMaterials.OPAL_ARMOR_MATERIAL, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(5))));
